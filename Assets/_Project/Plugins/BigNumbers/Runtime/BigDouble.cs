...
namespace Plugins.BigNumbers
{
    ...
    public struct BigDouble : IFormattable, IComparable, IComparable<BigDouble>, IEquatable<BigDouble>
    {
        ...
        public static BigDouble Lerp(BigDouble a, BigDouble b, float t)
        {
            return b * t + (1 - t) * a;
        }

        public static float InverseLerp(BigDouble a, BigDouble b, BigDouble value)
        {
            return (float) ((value - a) / (b - a)).ToDouble();
        }
